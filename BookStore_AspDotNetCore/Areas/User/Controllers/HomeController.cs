    ...
    public class HomeController : Controller
    {
        ...
        public IActionResult Details(ShoppingCart shoppingCart)
        {
            ...
            ShoppingCart cartFromDb = _unitOfWork.ShoppingCart.GetFirstOrDefault(
                x => x.ApplicationUserId == shoppingCart.ApplicationUserId 
            ...
            if(cartFromDb is null)
            {
                ...
                _unitOfWork.Save();
                HttpContext.Session.SetInt32(SD.SessionCart,_unitOfWork.ShoppingCart.GetAll(x => x.ApplicationUserId == shoppingCart.ApplicationUserId).ToList().Count);
            }
            else
            {
